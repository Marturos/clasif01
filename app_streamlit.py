...
# 02---------------- Variables globales para los campos del formulario-----------------------Menu de opciones para las variables
...
# ----------------------- Función para validar los campos del formulario----------------------------Validar los inputs
def validate_inputs():
    global error_flag
